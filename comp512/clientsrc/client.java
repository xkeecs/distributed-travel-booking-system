...
public class client
{
	...
	public static int start()
	{
		try
		{
			int Txid = rm.start();
			transactionid = Txid;
			System.out.println("Transaction Started. Transaction ID: " + Txid);
			return Txid;
	...
	public static void main(String[] args) throws Exception
	{
		...
		while (true)
		{
			...
			case 24: // commit a transaction
				...
				try
				{
					int id = obj.getInt(arguments.elementAt(1));
					if (rm.prepare(id))
					{
						System.out.println("Commit successfully!");
					}
					...
					{
						System.out.println("Commit is not succesful, abort all");
					}
				}
				catch (Exception e)
				{
			...
			case 26: // shutdown servers
				...
				try
				{
					String name = obj.getString(arguments.elementAt(1));
					rm.crash(name);
				}
				catch (Exception e)
				{
			...
			case 30:
				...
				System.out.println("please use command setDieAfterPrepare");
				/*
				 * try { String name = obj.getString(arguments.elementAt(1)); rm.setcase3(name); } catch (Exception e) {
				 * System.out.println("EXCEPTION:"); System.out.println(e.getMessage()); e.printStackTrace(); }
				 */
				break;
			case 31:
	...
	public int findChoice(String argument)
	{
		if (argument.compareToIgnoreCase("help") == 0)
			...
			return 27;
		else if (argument.compareToIgnoreCase("shutdownrmcase1") == 0)
			return 28;
		else if (argument.compareToIgnoreCase("shutdownrmcase2") == 0)
			return 29;
		else if (argument.compareToIgnoreCase("shutdownrmcase3") == 0)
			return 30;
		else if (argument.compareToIgnoreCase("shutdownrmcase4") == 0)
			return 31;
		else
			return 666;
	}
	...
	public void listSpecific(String command)
	{
		...
		case 27:
			System.out.println("KillAfterPrepare");
		case 28:
			System.out.println("shutdownrmcase1");
		case 29:
			System.out.println("shutdownrmcase2");

		case 30:
			System.out.println("shutdownrmcase3");

		case 31:
			System.out.println("shutdownrmcase4");
